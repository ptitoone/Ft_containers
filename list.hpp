...
namespace ft
{
	...
	class list
	{
		...
		public:
			...
			typedef ft::NormalIterator<pointer, list>   		iterator;
			typedef ft::NormalIterator<const_pointer, list>   const_iterator;
		...
		public:
			...
			list(	InputIt _first, InputIt _last,
    ...
    bool
    operator==(list<T, Alloc> const & _lhs, list<T, Alloc> const & _rhs) {
    ...
    void
    swap(list<T, Alloc>& _lhs, list<T, Alloc>& _rhs)
    { _lhs.swap(_rhs); }
};