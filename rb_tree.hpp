...
namespace ft
{
	...
	struct _rbt_iterator
	{
		...
		_base_ptr							_M_node;
		_rbt_iterator(): _M_node() { }
	
		explicit
											_rbt_iterator( _link_type _x ): _M_node( _x ) { }
	...
	struct _rbt_const_iterator
	{
		...
		_base_ptr									_M_node;
													...
													_rbt_const_iterator( void ): _M_node() { }
		
		explicit									_rbt_const_iterator( _link_type _x ): _M_node( _x ) { }
		
		_rbt_const_iterator( const iterator& _it ): _M_node( _it._M_node ) { }
	...
	template<typename _val>
	inline bool											operator==( const _rbt_iterator<_val>& _x, const _rbt_const_iterator<_val>& _y )
	...
	void												_rbt_rotate_left( _rbt_node_base* const _x, _rbt_node_base*& _root );
	
	void												_rbt_rotate_right( _rbt_node_base* const _x, _rbt_node_base*& _root );
	void												_rbt_insert_and_rebalance( const bool _insert_left, _rbt_node_base* _x, _rbt_node_base* _p, _rbt_node_base& _header );
	
	_rbt_node_base*										_rbt_rebalance_for_erase( _rbt_node_base* const _z, _rbt_node_base& _header );
	...
	class _rbt
	{
		typedef typename _alloc::template rebind<_rbt_node<_val> >::other	_node_allocator;
			...
			allocator_type 								get_allocator() const { return *static_cast<const _node_allocator*>( &this->_M_impl ); }
	
		protected:
			_rbt_node*									_M_get_node() { return _M_impl._node_allocator::allocate( 1 ); }
	
			void										_M_put_node( _rbt_node* _p ) { _M_impl._node_allocator::deallocate( _p, 1 ); }
			...
			protected:
				...
				struct _rbt_impl : public _node_allocator
				{
					...
					_rbt_impl( const _node_allocator& _allocate= _node_allocator(), const _key_compare& _comp = _key_compare() ):
			...
			protected:
				...
				static const_reference	_S_value( _const_link_type _x ) { return _x->_M_value_field; }
				static const _key&		_S_key( _const_link_type _x ) { return _keyOfValue()( _S_value( _x ) ); }
				static _link_type		_S_left( _base_ptr _x ) { return static_cast<_link_type>( _x->_M_left ); }
				static _const_link_type	_S_left( _const_base_ptr _x ) { return static_cast<_const_link_type>( _x->_M_left ); }
				static _link_type		_s_right( _base_ptr _x ) { return static_cast<_link_type>( _x->_M_right ); }
				static _const_link_type	_s_right( _const_base_ptr _x ) { return static_cast<_const_link_type>( _x->_M_right ); }
				static const_reference	_S_value( _const_base_ptr _x ) { return static_cast<_const_link_type>( _x )->_M_value_field; }
				static const _key&		_S_key( _const_base_ptr _x ) { return _keyOfValue()( _S_value( _x ) ); }
				static _base_ptr		_S_minimum( _base_ptr _x ) { return _rbt_node_base::_S_minimum( _x ); }
				static _const_base_ptr	_S_minimum( _const_base_ptr _x ) { return _rbt_node_base::_S_minimum( _x ); }
	
				static _base_ptr		_S_maximum( _base_ptr _x ) { return _rbt_node_base::_S_maximum( _x ); }
	
				static _const_base_ptr	_S_maximum( _const_base_ptr _x ) { return _rbt_node_base::_S_maximum( _x ); }
			...
			private:
				iterator	_M_insert( _base_ptr _x, _base_ptr _y, const value_type& _value );
	
			const_iterator	_M_insert( _const_base_ptr _x, _const_base_ptr _y, const value_type& _value );
			...
			public:
							_rbt() { }
							_rbt( const _compare& _comp ): _M_impl( allocator_type(), _comp ) { }
							_rbt( const _compare& _comp, const allocator_type& _allocate ): _M_impl( _allocate, _comp ) { }
							_rbt( const _rbt<_key, _val, _keyOfValue, _compare, _alloc>& _x ): _M_impl( _x.get_allocator(), _x._M_impl._M_key_compare )
							{
								if ( _x._M_root() != 0 )
								{
			...
			void												swap( _rbt<_key, _val, _keyOfValue, _compare, _alloc>& _t );
	
			ft::pair<iterator,bool>								insert_unique( const value_type& _x );
	
			iterator											insert_equal( const value_type& _x );
	
			iterator											insert_unique( iterator _position, const value_type& _x );
	
			const_iterator										insert_unique( const_iterator _position, const value_type& _x );
	
			iterator											insert_equal( iterator _position, const value_type& _x );
	
			const_iterator										insert_equal( const_iterator _position, const value_type& _x );
	
			template<typename _InputIterator>
			void												insert_unique( _InputIterator _first, _InputIterator _last );
	
			template<typename _InputIterator>
			void												insert_equal( _InputIterator _first, _InputIterator _last );
	...
	inline bool		operator==( const _rbt<_key, _val, _keyOfValue, _compare, _alloc>& _x,
	...
	template<typename _key, typename _val, typename _keyOfValue, typename _compare, typename _alloc>
	inline void		swap( 	_rbt<_key, _val, _keyOfValue, _compare, _alloc>& _x,
	...
	template<typename _key, typename _val, typename _keyOfValue, typename _compare, typename _alloc>
	void _rbt<_key, _val, _keyOfValue, _compare, _alloc>::swap( _rbt<_key, _val, _keyOfValue, _compare, _alloc>& _t )
	{
		if ( _M_root() == 0 )
		{
			if ( _t._M_root() != 0 )
	...
	template<class _II>
	void	_rbt<_key, _val, _keyOfValue, _cmp, _alloc>::insert_equal( _II _first, _II _last )
	{
	...
	template<typename _key, typename _val, typename _keyOfValue, typename _cmp, typename _alloc>
	template<class _II>
	void	_rbt<_key, _val, _keyOfValue, _cmp, _alloc>::insert_unique( _II _first, _II _last )
	{
		for ( ; _first != _last; ++_first )
	...
	template<typename _key, typename _val, typename _keyOfValue, typename _compare, typename _alloc>
	inline void	_rbt<_key, _val, _keyOfValue, _compare, _alloc>::erase( iterator _position )
	{
	...
	template<typename _key, typename _val, typename _keyOfValue, typename _compare, typename _alloc>
	inline void	_rbt<_key, _val, _keyOfValue, _compare, _alloc>::erase( const_iterator _position )
	{
	...
	template<typename _key, typename _val, typename _keyOfValue, typename _compare, typename _alloc>
	void	_rbt<_key, _val, _keyOfValue, _compare, _alloc>::_M_erase( _link_type _x )
	{
		while ( _x != 0 )
		{
	...
	template<typename _key, typename _val, typename _keyOfValue, typename _compare, typename _alloc>
	void	_rbt<_key, _val, _keyOfValue, _compare, _alloc>::erase( iterator _first, iterator _last )
	{
	...
	template<typename _key, typename _val, typename _keyOfValue, typename _compare, typename _alloc>
	void	_rbt<_key, _val, _keyOfValue, _compare, _alloc>::erase( const_iterator _first, const_iterator _last )
	{
		if ( _first == begin() && _last == end() )
			clear();
		else
	...
	template<typename _key, typename _val, typename _keyOfValue, typename _compare, typename _alloc>
	void	_rbt<_key, _val, _keyOfValue, _compare, _alloc>::erase( const _key* _first, const _key* _last )
	{
		while ( _first != _last )
			erase( *_first++ );
	}
	...
	template<typename _key, typename _val, typename _keyOfValue, typename _compare, typename _alloc>
	bool	_rbt<_key,_val,_keyOfValue,_compare,_alloc>::_rb_verify() const
	{
	...
	const _rbt_node_base*	_rbt_increment( const _rbt_node_base* _x ) { return _rbt_increment( const_cast<_rbt_node_base*>( _x ) ); }
	...
	const _rbt_node_base* _rbt_decrement( const _rbt_node_base* _x ) { return _rbt_decrement( const_cast<_rbt_node_base*>( _x ) ); }
